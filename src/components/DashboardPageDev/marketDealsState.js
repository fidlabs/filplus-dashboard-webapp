...
export const MarketDealsState = ({ marketDealsState }) => {
  ...
  const renderTooltip = (props) => {
    ...
    return (
      <div className={s.chartTooltip}>
        ...
        {toggle === 'tab2' && (
          <div className={s.chartTooltipData}>
            Number of possible abuse deals: {providerData['anyTaggedDeals']}
            <br />
            Number of well-distributed deals:{' '}
            {providerData['wellDistributedDeals']}
            <br />
            Number of total deals: {providerData['totalDeals']}
          </div>
        )}
    ...
    <div className={s.chartWrap}>
      ...
      <ResponsiveContainer width="100%" aspect={2}>
        ...
        >
          ...
          <Bar
            stackId="a"
            dataKey={bar1Key(toggle)}
            fill="#F59B42"
            name={bar1Description(toggle)}
          />
          <Bar
            dataKey={bar2Key(toggle)}
            stackId="a"
            fill="green"
